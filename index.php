...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="temp.css"><!-- delete me later. temp css for database message -->
</head>
<body class="bkgrnd">
<?php session_start(); ?>
...
<div id="wrapper">
  ...
  <?php include 'footer.php' ?>
	...
	<script>/* temporary script message delete me later */
		var messageDiv = document.createElement("div");
		messageDiv.setAttribute("id","tempModal")
		var paragraph = document.createElement("p");
		var message = document.createTextNode("Our database is temporarily down. We are working on fixing some issues right now. Sorry for the inconvenience. \nClick anywhere to continue.");
		paragraph.appendChild(message);
		messageDiv.appendChild(paragraph);

		var dom = document.getElementById("content");
		document.body.appendChild(messageDiv,dom);
